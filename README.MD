...
- [ ] Log all login events (success, failed) with key information like source IP, device, datetime,...
- [ ] Enable/disable send notification of every login activity
...
- [ ] Multiple unsuccessfully requests logging. Lock the account until supervisor unlocks.
